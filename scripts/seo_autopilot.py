...
- "body_html": ОСНОВНОЙ текст в HTML. КРИТИЧНО: НЕ МЕНЕЕ 900 слов — короткий тонкий текст
  ...
  Каждый раздел — РАЗВЁРНУТО (4-6 предложений), с КОНКРЕТИКОЙ, примерами, цифрами, без воды.
  ...
  (3) «пошагово через VideoAI» — детально: загрузка фото на botisk.ru, подсказка движения, ~60 сек, первое бесплатно;
